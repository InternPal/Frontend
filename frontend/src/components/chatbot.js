...
const Chatbot = ({name, job})=>{
    ...
    const [messages, setMessages] = useState([
          ...
          },
        {
            ...
            type: 'text',
            data: {
              text: 'My name is Intern Pal Singh Bhatia and you can ask me any query you have about '+ (job.jobType === "Internship" ? "Internship" : "Full Time Job") + " at " + job.name
            }
          }
    ]);
    ...
    return <div><Launcher
        agentProfile={{
          teamName: 'Intern Pal Singh Bhatia',
